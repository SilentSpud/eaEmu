...
class LoginServer(Protocol):
    ...
    def recv_login(self, msg):
        ...
        self.sendMsg(
            MessageFactory.getMessage(
                [("lc", "2"), ("sesskey", str(random.getrandbits(32))), ("proof", gs_login_proof(pwd, user, msg.challenge, self.sChal)), ("userid", str(random.getrandbits(32))), ("profileid", str(random.getrandbits(32))), ("uniquenick", user), ("lt", "XdR2LlH69XYzk3KCPYDkTY__"), ("id", "1")]
            )
        )
